...
| 다음 액션 | 후보(택1): ①클라우드 어댑터+설정 UI(deriveEngines 불일치 해소·품질 레버) ②es/vi L1팩+UI로케일 ③SRT export ④Phase3 영상/제스처. 하우스키핑: DEVELOPMENT.md §14 로드맵 체크박스 stale → 현실 반영. — 회차별 추이 그래프 ✅완료 |
| 최근 갱신 | 2026-06-21 |
