...
**결론**: `WAV2VEC2_GOP_THRESHOLD` 기본값 **0.3**. 절대 정확도(F1 0.31)는 여전히 낮음 — 다음 개선은 강제정렬 견고화(정상 단어 conf≈0 FP 제거) 또는 음소 단위 재설계. 재현: `SPEECHOCEAN762_DIR=/path PRONUNCIATION_SCORER=wav2vec2 LIMIT=200 pnpm eval:pronunciation`.
